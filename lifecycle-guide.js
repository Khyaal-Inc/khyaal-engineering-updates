...
const VIEW_INFO_CARDS = {
    ...
    sprint: {
        ...
        agenda: [
            ...
            'Cycle end: Execute Close Sprint Ceremony (Rollover & Velocity)',
        ],
    ...
    okr: {
        ...
        agenda: [
            ...
            'Monthly: review progress & update % complete',
            'Quarterly: Execute Close OKR Ceremony to score outcomes',
        ],
    ...
    epics: {
        ...
        agenda: [
            ...
            'End-of-life: Execute Close Epic Ceremony to cleanup tasks',
        ],
    ...
    releases: {
        ...
        agenda: [
            ...
            'Execute Ship Release Ceremony to finalize production version',
